...
morton_decode(uint64_t m, uint32_t *xto, uint32_t *yto, uint32_t *zto)
{
...
__host__ __device__ __forceinline__ static uint64_t
morton_encode(const uint32_t xsrc, const uint32_t ysrc, const uint32_t zsrc)
{
  static constexpr uint64_t mask0 =
      BITMASK_0000000001000001000001000001000001000001000001000001000001000001;
  static constexpr uint64_t mask1 =
